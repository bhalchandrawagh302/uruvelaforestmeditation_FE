...
export const TRANSLATIONS = {
  en: {
    ...
    navSupport: 'Support',
    navShare: 'Share',
    shareSubtitle: 'Spread the Dhamma with others',
    ...
    endDate: 'End Date',
    dateFixedNotice: 'Fixed by selected course schedule. Only editable from admin dashboard.',
    statusOngoing: 'Ongoing',
    registrationClosedDay7: 'Registration Closed (Day 7+)',
    fullName: 'Full Name',
  ...
  hi: {
    ...
    navSupport: 'सहयोग',
    navShare: 'साझा करें',
    shareSubtitle: 'धम्म का प्रसार दूसरों के साथ करें',
    ...
    dateFixedNotice: 'चयनित पाठ्यक्रम अनुसूची के अनुसार नियत (केवल व्यवस्थापक डैशबोर्ड से संपादन योग्य)।',
    statusOngoing: 'प्रगति पर',
    registrationClosedDay7: 'पंजीकरण बंद (7वें दिन बाद)',
    fullName: 'पूरा नाम',
  ...
  mr: {
    ...
    navSupport: 'सहकार्य',
    navShare: 'शेअर करा',
    shareSubtitle: 'इतरांसोबत धम्म शेअर करा',
    ...
    dateFixedNotice: 'निवडलेल्या अभ्यासक्रमाच्या वेळापत्रकानुसार निश्चित (केवळ व्यवस्थापक डॅशबोर्डद्वारे संपादनक्षम).',
    statusOngoing: 'सुरू आहे',
    registrationClosedDay7: 'नोंदणी बंद (७ व्या दिवसानंतर)',
    fullName: 'पूर्ण नाव',
